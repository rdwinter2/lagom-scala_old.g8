...
////    val salt64 = Base64.getUrlEncoder().encodeToString(salt)
////    val hash64 = Base64.getUrlEncoder().encodeToString(hash)
...
////    val hash = new String(Base64.getUrlDecoder().decode(hashParts(1)))
////    val salt = new String(Base64.getUrlDecoder().decode(hashParts(2)))
